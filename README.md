...
![Version: 8.0.4-bb.6](https://img.shields.io/badge/Version-8.0.4--bb.6-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 9.9.4](https://img.shields.io/badge/AppVersion-9.9.4-informational?style=flat-square)
...
| image.tag | string | `"9.9.4-community"` |  |
...
| waitForDb.image | string | `"registry1.dso.mil/ironbank/opensource/postgres/postgresql12:12.18"` |  |
...
| postgresql.image.tag | string | `"12.18"` |  |
