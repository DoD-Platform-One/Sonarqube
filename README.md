...
| community.buildNumber | string | `"25.5.0.107428"` |  |
| image.repository | string | `"registry1.dso.mil/ironbank/sonarsource/sonarqube/sonarqube-community-build"` |  |
| image.tag | string | `"25.1.0.102122-community"` |  |
...
| initSysctl.securityContext.readOnlyRootFilesystem | bool | `true` |  |
| initFs.enabled | bool | `true` |  |
...
| initFs.securityContext.readOnlyRootFilesystem | bool | `true` |  |
...
| plugins.image | string | `"registry1.dso.mil/ironbank/sonarsource/sonarqube/sonarqube-community-build:25.1.0.102122-community"` |  |
...
| jdbcOverwrite.enabled | bool | `false` |  |
| jdbcOverwrite.jdbcUrl | string | `"jdbc:postgresql://myPostgress/myDatabase"` |  |
...
| curlContainerImage | string | `"registry1.dso.mil/ironbank/redhat/ubi/ubi8:8.10"` |  |
